...
|  --- | --- | --- |
|  [chooseNormalizer(wantNormalization, haveNormalization)](./ts-bcp47.bcp47.normalizetag.choosenormalizer.md) | <code>static</code> | Chooses an appropriate default tag normalizer given desired and optional current [normalization level](./ts-bcp47.bcp47.tagnormalization.md)<!-- -->. |
